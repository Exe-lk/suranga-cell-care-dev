...
export const CashierPagesMenu1 = {
	bill: {
		id: 'bill',
		text: ' Accessory Bill',
...
export const AccessoryBillKeeper = {
	...
	Print: {
		id: 'print',
		text: 'Purchasing History',
		path: 'accessory-sales-assitant/purchasing-history',
		icon: 'AutoStories',
		subMenu: null,
	},
	return: {
		id: 'print56',
		text: 'Return History',
		path: 'accessory-sales-assitant/return-history',
		icon: 'AutoStories',
		subMenu: null,
	},
...
export const stockElePagesMenu = {
	...
	return: {
		id: 'print56',
		text: 'Return History',
		path: 'display-stock/return-history',
		icon: 'AutoStories',
		subMenu: null,
	},
}
...
export const RapairSalePagesMenu = {
	dashboard1: {
		id: 'dashboard1',
		text: 'Dashboard',
		path: 'rapair-sales-assistant/dashboard',
		icon: 'Dashboard',
		subMenu: null,
	},
	bill: {
		id: 'dashboard',
		text: 'Bill management',
		path: 'rapair-sales-assistant/bill-management',
		icon: 'MenuBook',
		subMenu: null,
	},
	Repaired: {
		id: 'stock1',
		text: 'Repaired Phone',
		path: 'rapair-sales-assistant/rapaired-phone',
		icon: 'PhonelinkSetup',
		subMenu: null,
	},
	Waiting: {
		id: 'stock2',
		text: 'Waiting',
		path: 'rapair-sales-assistant/Waiting',
		icon: 'ContactPhone',
		subMenu: null,
	},
	ReadytoRepair: {
		id: 'stock2',
		text: 'Ready to Repair',
		path: 'rapair-sales-assistant/Ready-to-Repair',
		icon: 'SettingsPhone',
		subMenu: null,
	},
	InProgress: {
		id: 'stock2',
		text: 'In Progress',
		path: 'rapair-sales-assistant/In-Progress',
		icon: 'PhonelinkLock',
		subMenu: null,
	},
	Reject: {
		id: 'stock2',
		text: 'Reject',
		path: 'rapair-sales-assistant/Reject',
		icon: 'PhoneDisabled',
		subMenu: null,
	},
	RepairCompleted: {
		id: 'stock2',
		text: 'Repair Completed',
		path: 'rapair-sales-assistant/Repair-Completed',
		icon: 'PhoneIphone',
		subMenu: null,
	},
	HandOver: {
		id: 'stock2',
		text: 'HandOver',
		path: 'rapair-sales-assistant/HandOver',
		icon: 'WavingHand',
		subMenu: null,
	},
...
export const repairsalesMenu ={
	bill: {
		id: 'dashboard',
		text: 'Bill management',
		path: 'repairSales/bill-management',
		icon: 'MenuBook',
		subMenu: null,
	},
	Waiting: {
